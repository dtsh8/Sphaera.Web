...
using Sphaera.IdentityServer.Attributes;
using Sphaera.IdentityServer.Extensions;
using Sphaera.IdentityServer.Models;
using Sphaera.IdentityServer.ViewModels.Account;
using Sphaera.IdentityServer.ViewModels.Consent;

namespace Sphaera.IdentityServer.Controllers
{
